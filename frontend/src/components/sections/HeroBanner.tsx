...
export const HeroBanner: React.FC = () => {
  return (
    <section className="relative min-h-[700px] flex items-center bg-[#F8F3EC] overflow-hidden pt-24 pb-32">
      ...
      <div 
        className="absolute left-0 top-0 bottom-0 w-1/2 opacity-60 pointer-events-none bg-no-repeat bg-left-bottom"
        style={{ 
      ...
      <div className="max-w-[1400px] mx-auto w-full px-5 md:px-10 lg:px-20 relative z-10 flex flex-col lg:flex-row items-center">
        ...
        {/* Left Content */}
        <div className="flex-1 w-full lg:w-1/2 lg:pr-12 pt-10 lg:pt-0">
      ...
      {/* Mobile Image */}
      <div className="lg:hidden w-full mt-12 relative z-0 px-5">
         <img 
            src="/service_pheta.png" 
            alt="Royal Maharashtrian Wedding Pheta" 
